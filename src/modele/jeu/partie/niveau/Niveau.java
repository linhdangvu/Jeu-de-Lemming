...
public class Niveau {
	...
	public Niveau(File fic) throws FichierInvalideException {
		...
		this.infos.addDetailsAptitudes(TypeAptitude.GRIMPEUR, 0);
		this.infos.addDetailsAptitudes(TypeAptitude.PARACHUTISTE, 0);
		this.infos.addDetailsAptitudes(TypeAptitude.BLOQUEUR, 0);
		this.infos.addDetailsAptitudes(TypeAptitude.BOMBEUR, 0);
		this.infos.addDetailsAptitudes(TypeAptitude.CHARPENTIER, 0);
//		this.infos.addDetailsAptitudes(TypeAptitude.BASHER, 0);
		this.infos.addDetailsAptitudes(TypeAptitude.FOREUR, 0);
		...
		try {
			...
			while (((ligne != null) && !ligne.startsWith("map"))) {
				...
				// vitesse d'apparition des lemmings
					...
					// Les aptitudes
					case "climber":
						this.infos.addDetailsAptitudes(TypeAptitude.GRIMPEUR,
								Integer.parseInt(ligneParsee[1]));
						break;
					case "floater":
						this.infos.addDetailsAptitudes(TypeAptitude.PARACHUTISTE,
								Integer.parseInt(ligneParsee[1]));
						break;
					case "blocker":
						this.infos.addDetailsAptitudes(TypeAptitude.BLOQUEUR,
								Integer.parseInt(ligneParsee[1]));
						break;
					case "bomber":
						this.infos.addDetailsAptitudes(TypeAptitude.BOMBEUR,
								Integer.parseInt(ligneParsee[1]));
						break;
					case "builder":
						this.infos.addDetailsAptitudes(TypeAptitude.CHARPENTIER,
								Integer.parseInt(ligneParsee[1]));
						break;
//					case "basher":
...
//						break;
					case "digger":
						this.infos.addDetailsAptitudes(TypeAptitude.FOREUR,
								Integer.parseInt(ligneParsee[1]));
						break;
//					case "miner":
