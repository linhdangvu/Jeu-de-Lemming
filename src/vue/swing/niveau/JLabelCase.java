...
public class JLabelCase extends JLabel {
	...
	private final ImageIcon LEM_D = new ImageIcon("resources/lem_verd.png");
	private final ImageIcon LEM_G = new ImageIcon("resources/Lem_verg.png");
	private final ImageIcon LEM_BLOCK = new ImageIcon("resources/lem_block.png");
	private final ImageIcon LEM_TOMBE = new ImageIcon("resources/lem_tombe.png");
	private final ImageIcon LEM_GRIMPE = new ImageIcon("resources/lem_grimpe.png");
	private final ImageIcon LEM_PARA = new ImageIcon("resources/lem_para.png");
	
	private final ImageIcon DESTRUCTIBLE = new ImageIcon("resources/rambi_crate.png");
	...
	private final ImageIcon SORTIE = new ImageIcon("resources/sortie_target.png");
	...
	public void setlemmingColor(Lemming lem) {
		...
		switch(tAp)
		{
			...
			case PARACHUTISTE:
				...
				if(m.tombe())
				{
					if(tAp == TypeAptitude.PARACHUTISTE)
